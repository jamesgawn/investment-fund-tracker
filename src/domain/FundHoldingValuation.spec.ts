...
describe("FundHoldingValuation", () => {
  describe("constructor", () => {
    test("should create fund holding valuation with populated values", () => {
      ...
      const fundHoldingValuation = new FundHoldingValuation(fundPrice, fundHolding);
      ...
      expect(fundHoldingValuation.currentValue).toBe(5000);
      expect(fundHoldingValuation.originalValue).toBe(4500);
      expect(fundHoldingValuation.amount).toBe(100);
      expect(fundHoldingValuation.originalPrice).toBe(45);
      expect(fundHoldingValuation.profitValue).toBe(500);
